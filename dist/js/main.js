...
(function () {
    ...
    function openGuide() {
        ...
        guideIndex = guideHints.length > 0 ? 0 : -1;  // Show first hint immediately if available
        guideActive = true;
    ...
    function applyGuideMove() {
        ...
        givenMask[hint.row][hint.col] = true;  // Mark as fixed so it shows as "given"
        ...
        checkWin();
        renderGrid();  // Re-render to show the applied move
        updateGuideDisplay();
    }
